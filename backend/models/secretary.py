...
class Secretary(Person):
    ...
    __mapper_args__ = {"polymorphic_identity": "secretary"}
    ...
    packages = relationship(
        "Package", foreign_keys="Package.secretary_id", back_populates="secretary"
    )
    delivered_packages = relationship(
        "Package", foreign_keys="Package.delivered_by_secretary_id"
    )
