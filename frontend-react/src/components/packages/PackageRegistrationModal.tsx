...
export default function PackageRegistrationModal({
    ...
    return (
        <>
            <div className={cn("fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-sm transition-all duration-300", showReceiptModal ? "hidden" : "opacity-100")}>
