    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          .ts-stats    { display: none !important; }
      ...
      <div className="ts-page">
        ...
        {trip && !isLoading && !hasError && (
          <div className="ts-stats">
            ...
            <div className="ts-stat">
              <div className="ts-stat-label">Fecha</div>
              <div className="ts-stat-value" style={{ fontSize: 14 }}>{formatDate(trip.trip_datetime)}</div>
              <div className="ts-stat-sub">{formatTime(trip.departure_time)}</div>
            </div>
          </div>
        )}
