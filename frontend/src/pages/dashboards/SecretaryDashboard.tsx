...
export function Component() {
  ...
  const { user } = useAuth()
  useDocumentTitle('Panel de Secretaria')
  ...
  const quickActions: QuickAction[] = [
    {
      ...
      icon: (
        <svg aria-hidden="true" className="h-5 w-5 lg:h-6 lg:w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div>
      <h1 className="sr-only">Panel de Secretaria</h1>
              ...
              <div className="xl:col-span-3 space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardAction>
                      <Button variant="link" size="sm" onClick={() => navigate(ROUTES.TRIPS)} aria-label="Ver todos los viajes">
                        Ver todos
                      </Button>
                    </CardAction>
                  </CardHeader>
