    ...
    <div id="receipt-content" className="bg-white">
      <div className="p-4 max-w-3xl mx-auto bg-white border-2 border-blue-800 rounded-lg font-[Arial,sans-serif]">
        ...
        <div className="text-xs text-blue-700 mb-6 font-medium leading-relaxed">
          <p><span aria-hidden="true">📍</span> <strong>Of. {OFFICES.santa_cruz.name}:</strong> {OFFICES.santa_cruz.address} • <strong>Cel.:</strong> {OFFICES.santa_cruz.phone}</p>
          <p><span aria-hidden="true">📍</span> <strong>Of. {OFFICES.comarapa.name}:</strong> {OFFICES.comarapa.address} • <strong>Cel.:</strong> {OFFICES.comarapa.phone}</p>
          <p><span aria-hidden="true">📍</span> <strong>Of. {OFFICES.san_isidro.name}:</strong> {OFFICES.san_isidro.address} • <strong>Cel.:</strong> {OFFICES.san_isidro.phone}</p>
          <p><span aria-hidden="true">📍</span> <strong>Of. {OFFICES.los_negros.name}:</strong> {OFFICES.los_negros.address} • <strong>Cel.:</strong> {OFFICES.los_negros.phone}</p>
        </div>
