  ...
  return (
    <>
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-800 mb-4">Valor Pagado</p>
        <h3 className="text-[40px] font-bold text-slate-800 leading-none mb-1 tracking-tight">Bs. {amount}</h3>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-800 mb-6">Manifiesto de ítems</p>
            ...
            (pkg.items as PackageItem[] || []).map((item) => (
              <div key={item.id} className="flex items-start gap-4">
                ...
                <div className="leading-tight">
                  <p className="text-[13px] font-bold text-slate-800 mb-0.5">{item.quantity}x {item.description}</p>
