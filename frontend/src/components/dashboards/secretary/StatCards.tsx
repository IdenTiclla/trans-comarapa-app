  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <DashboardStatCard
        ...
        icon={
          <svg aria-hidden="true" className="h-6 w-6 lg:h-8 lg:w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <DashboardStatCard
        ...
        icon={
          <svg aria-hidden="true" className="h-6 w-6 lg:h-8 lg:w-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <DashboardStatCard
        ...
        icon={
          <svg aria-hidden="true" className="h-6 w-6 lg:h-8 lg:w-8 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <DashboardStatCard
        ...
        icon={
          <svg aria-hidden="true" className="h-6 w-6 lg:h-8 lg:w-8 text-orange-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
