                        ...
                        {!isExpanded && (
                            <div className="hidden sm:flex items-center space-x-2 mr-2">
                                <button
                                    ...
                                    className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold py-2 px-3 rounded-lg shadow-sm transition-colors cursor-pointer"
                                    title="Vender selección"
                                >
                                    Vender
                                </button>
                                <button
                                    onClick={(e) => { e.stopPropagation(); onReserveSeat(); }}
                                    className="bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold py-2 px-3 rounded-lg shadow-sm transition-colors cursor-pointer"
                                    title="Reservar selección"
                                >
                                    Reservar
                                </button>
                            </div>
                ...
                <div className={`transition-all duration-300 ease-in-out ${isExpanded ? 'max-h-[60vh] opacity-100 visible overflow-y-auto' : 'max-h-0 opacity-0 invisible overflow-hidden'}`}>
                            ...
                            {selectedSeats.map(seat => (
                                <div key={seat.id} className="relative group bg-white border border-slate-200 shadow-sm rounded-lg p-2 text-center hover:border-indigo-400 hover:shadow-md transition-all cursor-default flex flex-col items-center justify-center min-h-[64px]">
                                    ...
                                    <button
                                        ...
                                        className="absolute -top-2 -right-2 bg-white text-slate-400 border border-slate-200 hover:bg-red-50 hover:text-red-600 hover:border-red-200 rounded-full p-1 opacity-0 group-hover:opacity-100 transition-all shadow-sm cursor-pointer z-10"
                    ...
                    <div className="p-4 bg-white border-t border-slate-100 grid grid-cols-2 gap-3 sm:gap-4 rounded-b-2xl">
                        <button
                            ...
                            className="col-span-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2.5 px-4 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center space-x-2 cursor-pointer focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                        >
                        ...
                        <button
                            ...
                            className="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-2.5 px-4 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center space-x-1 sm:space-x-2 text-sm cursor-pointer focus:ring-2 focus:ring-amber-400 focus:ring-offset-2"
                        >
                        ...
                        <button
                            ...
                            className="bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold py-2.5 px-4 rounded-xl transition-all flex items-center justify-center space-x-1 sm:space-x-2 text-sm cursor-pointer focus:ring-2 focus:ring-slate-300 focus:ring-offset-2"
                        >
                            <svg className="w-4 h-4 hidden sm:block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
