        ...
        <div className="animate-[slideUp_0.3s_ease-out] mb-6 mx-4 sm:mx-6 md:mx-8">
            <div className="bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 border border-indigo-200 rounded-2xl shadow-lg backdrop-blur-sm">
                ...
                <div className="px-6 py-4">
                    <div className="mb-4">
                        <span className="block text-sm font-semibold text-gray-700 mb-3">Asientos seleccionados:</span>
                            ...
                            {selectedSeats.map(seat => (
                                <div key={seat.id} className="group relative bg-white border-2 border-indigo-200 rounded-xl p-3 hover:border-indigo-400 hover:shadow-md transition-all duration-200 cursor-pointer">
                                    ...
                                    <Button
                                        ...
                                        className="absolute -top-2 -right-2 h-6 w-6 bg-red-500 hover:bg-red-600 text-white hover:text-white rounded-full shadow-lg opacity-0 group-hover:opacity-100"
                                    >
                                        <X className="h-3 w-3" />
                                    </Button>
                                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <Button
                            ...
                            className="h-auto bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg"
                        >
                        ...
                        <Button
                            ...
                            className="h-auto bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg"
                        >
                            <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <Button
                            ...
                            className="h-auto bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg"
                        >
                            <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
