...
export default function LoginLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row font-inter">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden min-h-screen" aria-hidden="true">
          ...
          <div className="w-full max-w-lg mx-auto text-center">
            <div className="mb-6 lg:mb-8 flex justify-center">
              <div className="bg-white/20 backdrop-blur-sm p-5 lg:p-6 rounded-2xl lg:rounded-3xl shadow-2xl">
                <svg aria-hidden="true" className="h-12 w-12 lg:h-16 lg:w-16 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="grid grid-cols-3 gap-4 lg:gap-6 mt-6 lg:mt-8">
              <div className="text-center">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl lg:rounded-2xl p-3 lg:p-4 mb-2 lg:mb-3 inline-flex justify-center">
                  <svg aria-hidden="true" className="h-5 w-5 lg:h-6 lg:w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="absolute bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2 flex space-x-2 z-20">
          {heroImages.map((_, index) => (
            <Button
              ...
              className={`w-7 h-7 lg:w-3 lg:h-3 min-w-0 rounded-full p-0 transition-all duration-300 hover:scale-110 ${
                index === currentSlide
      ...
      <main className="w-full lg:w-1/2 xl:w-2/5 min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 bg-gradient-to-br from-comarapa-gray via-white to-comarapa-gray">
