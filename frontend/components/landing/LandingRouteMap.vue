<template>
  <section id="rutas" class="py-16 sm:py-20 md:py-24 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Route info cards -->
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mt-10 sm:mt-12 md:mt-16">
        <div class="text-center">
          <div class="bg-comarapa-light/20 rounded-full p-3 sm:p-4 w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center">
            <svg class="h-7 w-7 sm:h-8 sm:w-8 text-comarapa-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
          </div>
          <h3 class="text-lg sm:text-xl font-bold text-comarapa-dark mb-2">Tiempo de Viaje</h3>
          <p class="text-sm sm:text-base text-gray-600">Aproximadamente 6-7 horas de Santa Cruz a Comarapa</p>
        </div>
        <div class="text-center">
          <div class="bg-comarapa-light/20 rounded-full p-3 sm:p-4 w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center">
            <svg class="h-7 w-7 sm:h-8 sm:w-8 text-comarapa-dark" fill="currentColor" viewBox="0 0 24 24">
              <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
              <path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
            </svg>
          </div>
          <h3 class="text-lg sm:text-xl font-bold text-comarapa-dark mb-2">Distancia Total</h3>
          <p class="text-sm sm:text-base text-gray-600">235 kilómetros de recorrido seguro y confortable</p>
        </div>
        <div class="text-center">
          <div class="bg-comarapa-light/20 rounded-full p-3 sm:p-4 w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 flex items-center justify-center">
            <svg class="h-7 w-7 sm:h-8 sm:w-8 text-comarapa-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <h3 class="text-lg sm:text-xl font-bold text-comarapa-dark mb-2">Seguridad</h3>
          <p class="text-sm sm:text-base text-gray-600">Conductores profesionales y buses inspeccionados</p>
        </div>
      </div>
    </div>
  </section>
