<template>
  <section id="servicios" class="py-24 bg-comarapa-gray">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16">
        <div class="inline-flex items-center gap-2 bg-comarapa-light/20 px-4 py-2 rounded-full mb-4">
          <svg class="h-5 w-5 text-comarapa-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
          </svg>
          <span class="text-comarapa-dark font-medium">Nuestros Servicios</span>
        </div>
        <h2 class="text-4xl md:text-5xl font-bold text-comarapa-dark mb-6">
      ...
      <div class="grid lg:grid-cols-2 gap-8 mb-16">
        ...
        <div class="comarapa-card p-8 bg-gradient-to-br from-comarapa-dark/5 to-comarapa-medium/5">
          <div class="flex items-center gap-4 mb-8">
            <div class="bg-gradient-to-br from-comarapa-dark to-comarapa-medium rounded-2xl p-4 shadow-lg">
              <svg class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
              </svg>
            </div>
            <h3 class="text-3xl font-bold text-comarapa-dark">Transporte de Pasajeros</h3>
          </div>
          <div class="grid md:grid-cols-2 gap-6">
            <ul class="space-y-4">
              <li v-for="item in passengerServicesLeft" :key="item" class="flex items-start gap-3">
                <svg class="h-5 w-5 text-comarapa-medium mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <ul class="space-y-4">
              <li v-for="item in passengerServicesRight" :key="item" class="flex items-start gap-3">
                <svg class="h-5 w-5 text-comarapa-medium mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                <span class="text-gray-700">{{ item }}</span>
        ...
        <div class="comarapa-card p-8 bg-gradient-to-br from-comarapa-light/10 to-green-100/50">
          <div class="flex items-center gap-4 mb-8">
            <div class="bg-gradient-to-br from-comarapa-medium to-comarapa-light rounded-2xl p-4 shadow-lg">
              <svg class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
              </svg>
            </div>
            <h3 class="text-3xl font-bold text-comarapa-dark">Envío de Encomiendas</h3>
          </div>
          <div class="grid md:grid-cols-2 gap-6">
            <ul class="space-y-4">
              <li v-for="item in packageServicesLeft" :key="item" class="flex items-start gap-3">
                <svg class="h-5 w-5 text-comarapa-medium mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                <span class="text-gray-700">{{ item }}</span>
            ...
            <ul class="space-y-4">
              <li v-for="item in packageServicesRight" :key="item" class="flex items-start gap-3">
                <svg class="h-5 w-5 text-comarapa-medium mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                <span class="text-gray-700">{{ item }}</span>
      ...
      <div class="comarapa-card p-8">
        <div class="text-center mb-12">
          <div class="bg-gradient-to-br from-comarapa-dark to-comarapa-light rounded-2xl p-4 w-20 h-20 mx-auto mb-6 flex items-center justify-center shadow-lg">
            <svg class="h-10 w-10 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/>
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/>
            </svg>
          </div>
          <h3 class="text-3xl font-bold text-comarapa-dark mb-4">Viajes Personalizados</h3>
          <p class="text-xl text-gray-600 max-w-2xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-6 gap-6">
          <div v-for="service in customServices" :key="service.title" 
               class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-gray-100">
            <div class="flex items-center gap-3 mb-4">
              <component :is="service.icon" :class="`h-6 w-6 ${service.color}`" />
...
const packageServicesLeft = [
  "Servicio rapido y eficiente",
  "Entrega en todas las localidades de la ruta",
  "Seguimiento en tiempo real",
  "Servicio express y regular",
]

const packageServicesRight = [
