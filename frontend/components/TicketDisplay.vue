<template>
  <div class="ticket-container bg-white rounded-lg overflow-hidden border-4 border-blue-400 max-w-4xl mx-auto shadow-2xl">
    <!-- Header principal con logo y información de la empresa -->
    <div class="ticket-header bg-gradient-to-r from-cyan-400 to-blue-500 text-white px-4 py-3 border-b-4 border-blue-600">
      <div class="flex items-start justify-between">
        <!-- Lado izquierdo: Logo del bus y texto -->
        <div class="flex items-start space-x-3">
          <!-- Logo del bus -->
          <div class="flex-shrink-0">
            <svg class="w-16 h-12 text-white" fill="currentColor" viewBox="0 0 100 60">
          ...
          <div>
            <div class="flex items-baseline space-x-2 mb-1">
              <h1 class="text-2xl font-bold">TRANS</h1>
              <h2 class="text-2xl font-bold italic">Comarapa</h2>
            </div>
        ...
        <div class="text-center">
          <p class="text-sm font-bold">Resolución Suprema 17996</p>
        </div>
        
        <!-- Lado derecho: Águila -->
        <div class="flex-shrink-0">
          <svg class="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 100 100">
      ...
      <div class="mt-2 grid grid-cols-2 gap-x-8 text-xs">
        <div>
    ...
    <div class="bg-white relative">
      ...
      <div class="absolute top-2 right-4">
        <div class="bg-blue-500 text-white px-6 py-2 rounded-lg">
          <h3 class="text-xl font-bold">BOLETO</h3>
        </div>
      </div>

      <div class="px-4 py-4 pt-16">
        <!-- Fila NOMBRE y N° -->
        <div class="border-4 border-blue-500 mb-2">
          <div class="flex">
            <!-- NOMBRE -->
            <div class="bg-blue-500 text-white px-4 py-3 font-bold text-lg">
              NOMBRE:
            </div>
            <!-- Espacio para el nombre -->
            <div class="flex-grow border-r-4 border-blue-500 bg-white px-4 py-3">
              <span class="text-gray-700">{{ getFullName() }}</span>
            </div>
            <!-- N° -->
            <div class="bg-white px-6 py-3 text-right">
              <span class="text-red-600 font-bold text-2xl">N° {{ ticket.id || '115032' }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-2 mb-2">
          <!-- Bs. -->
          <div class="col-span-2 border-4 border-blue-500">
            <div class="bg-blue-500 text-white text-center py-2 font-bold">Bs.</div>
            <div class="bg-white text-center py-4 text-xl font-bold">
              {{ formatPrice(ticket.price) }}
            </div>
          </div>

          <!-- Destino -->
          <div class="col-span-7 border-4 border-blue-500">
            <div class="bg-blue-500 text-white text-center py-2 font-bold">Destino:</div>
            <div class="bg-white text-center py-4 text-lg font-bold">
              {{ getDestination() }}
            </div>
          </div>
        ...
        <div class="grid grid-cols-12 gap-2 mb-4">
          <!-- Fecha -->
          <div class="col-span-4 border-4 border-blue-500">
            <div class="bg-blue-500 text-white text-center py-2 font-bold">Fecha</div>
            <div class="bg-white p-2">
              <div class="grid grid-cols-3 gap-1">
                <div class="border-2 border-blue-300 text-center py-2 font-bold">
                  {{ getDayFromDate() }}
                </div>
                <div class="border-2 border-blue-300 text-center py-2 font-bold">
                  {{ getMonthFromDate() }}
          ...
          <!-- Hora en Oficina -->
          <div class="col-span-4 border-4 border-blue-500">
            <div class="bg-blue-500 text-white text-center py-2 font-bold">Hora en Oficina:</div>
            <div class="bg-white p-2">
              <div class="flex justify-center space-x-2 mb-2">
                <span class="bg-blue-100 px-3 py-1 rounded font-bold text-blue-600">AM</span>
                <span class="bg-blue-100 px-3 py-1 rounded font-bold text-blue-600">PM</span>
              </div>
          ...
          <!-- Hora Salida -->
          <div class="col-span-4 border-4 border-blue-500">
            <div class="bg-blue-500 text-white text-center py-2 font-bold">Hora Salida:</div>
            <div class="bg-white p-2">
              <div class="flex justify-center space-x-2 mb-2">
                <span class="bg-blue-100 px-3 py-1 rounded font-bold text-blue-600">AM</span>
                <span class="bg-blue-100 px-3 py-1 rounded font-bold text-blue-600">PM</span>
    ...
    <!-- Footer -->
    <div class="bg-gradient-to-r from-cyan-400 to-blue-500 text-white px-4 py-3 border-t-4 border-blue-600">
      <div class="grid grid-cols-12 gap-4">
        <!-- NO SE ACEPTAN DEVOLUCIONES -->
        <div class="col-span-4">
          <div class="text-center">
            <p class="font-bold text-lg mb-1">NO SE ACEPTAN</p>
            <p class="font-bold text-lg mb-2">DEVOLUCIONES</p>
            <p class="italic text-sm">Gracias por su preferencia!!!</p>
          </div>
        </div>

        <!-- HORARIOS -->
        <div class="col-span-8">
          <div class="bg-blue-600 rounded px-3 py-2">
            <h4 class="text-center font-bold mb-2 text-sm">HORARIOS DE SALIDA DE SANTA CRUZ A COMARAPA</h4>
            <div class="text-xs leading-tight">
