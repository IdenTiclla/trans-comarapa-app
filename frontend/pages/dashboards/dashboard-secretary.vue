  ...
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
      <StatCard
        ...
        :value="stats.tickets ? stats.tickets.count : '...'"
        :icon="icons.ticketIcon"
        bgColor="bg-blue-500"
        :trend="stats.tickets ? stats.tickets.trend : 0"
        trendText="vs. ayer"
      />
      <StatCard
        title="Ingresos del Día"
        :value="stats.tickets ? `Bs. ${stats.tickets.amount.toLocaleString()}` : '...'"
      ...
      <StatCard
        ...
        :value="stats.packages ? stats.packages.count : '...'"
        :icon="icons.packageIcon"
        bgColor="bg-purple-500"
        :trend="stats.packages ? stats.packages.trend : 0"
        trendText="vs. ayer"
      />
      <StatCard
        title="Viajes Programados"
        :value="stats.trips ? stats.trips.count : '...'"
        :icon="icons.busIcon"
        bgColor="bg-orange-500"
        :trend="stats.trips ? stats.trips.trend : 0"
        trendText="vs. ayer"
      />
    </div>
