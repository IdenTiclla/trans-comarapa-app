...
All documentation lives in [`docs/`](docs/) — start at [docs/INDEX.md](docs/INDEX.md) for the full index. For Docker setup specifically, see [README-Docker.md](README-Docker.md).
